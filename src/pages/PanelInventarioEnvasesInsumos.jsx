...
export default function PanelInventarioEnvasesInsumos() {
  ...
  return (
    <main className="flex w-full flex-col gap-6 p-6 md:p-10">
      <header className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-marron-cafe">Existencias — Envases e Insumos</h1>
          <p className="text-sm text-marron-cafe/60">Stock disponible y bloqueado de envases, embalajes e insumos de proceso.</p>
        </div>
      </header>

      <SeccionExistenciasAlmacen grupoFijo="Envases/Embalajes e Insumos de Proceso" />
    </main>
  )
}
