...
export default function BotonVolver({ onClick, ariaLabel = 'Volver' }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex size-9 shrink-0 items-center justify-center rounded-full border border-marron-tierra/20 text-marron-cafe transition-colors duration-150 hover:bg-marron-tierra/5"
