...
import { ClipboardCheck, ClipboardList, Factory, MapPin, ShoppingCart, TestTubes, Warehouse } from 'lucide-react'
...
// Trazabilidad de lotes: listado + al clickear uno, su recorrido completo
// por Compras/Almacén/Calidad/Producción/Laboratorio (GET
// /lots/:id/traceability, ver comrural_erp_backend/docs/lot-traceability.md,
...
export default function SeccionTrazabilidad() {
