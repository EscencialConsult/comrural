...
import { Layers, Scale, Gauge, FileSearch } from 'lucide-react'
...
const SUBPESTAÑAS_AREA_A = [
  ...
  // Punto 3 del relevamiento: acceso de Producción a informes de Calidad y
  // Laboratorio (pureza/impurezas, calidad del agua) — mock, ver
  // InformesCalidadLaboratorio.jsx.
